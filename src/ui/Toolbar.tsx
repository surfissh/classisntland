...
const Toolbar = () => {
  ...
  const positionClasses: Record<string, string> = {
    ...
    floating: `bottom-6 left-1/2 -translate-x-1/2 flex-row rounded-xl shadow-2xl`,
  };
  ...
  const compactClasses: Record<string, string> = {
  ...
  const containerClass = `
    ...
    ${toolbarMode === 'fill'
      ...
      : compactClasses[toolbarPosition] || compactClasses.bottom
    }
  `;
  ...
  const toolbarContent = (
    <>
      <PageManager toolPosition={isVertical ? 'center' : 'left'} />
